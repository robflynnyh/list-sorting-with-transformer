...
| On a harder autoregressive retrieval trace, matched 20,000-step entmax models reached 100% exact accuracy through sampled length 5,000, both with and without a final KEEP/SWAP target. Softmax reached 10.9% without the action target and 46.9% with it at length 5,000. | Preliminary | [KEEP/SWAP comparison](experiments/sparse_attention_adam/README.md#keepswap-extension), [comparison JSON](experiments/sparse_attention_adam/results/pointer_compare_summary.json) |
